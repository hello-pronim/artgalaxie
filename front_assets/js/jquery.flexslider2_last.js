...
(function ($) {
  ...
  $.flexslider2 = function(el, options) {
    ...
    slider.vars = $.extend({}, $.flexslider2.defaults, options);
    ...
    methods = {
        ...
        setup: function() {
          ...
          if(!msGesture){
              slider.slides.click(function(e){
                ...
                } else if (!$(slider.vars.asNavFor).data('flexslider2').animating && !$slide.hasClass(namespace + "active-slide")) {
              ...
              slider.slides.each(function (){
                  ...
                  that.addEventListener("MSGestureTap", function (e){
                      ...
                      var $slide = $(this),
                          target = $slide.index();
                      if (!$(slider.vars.asNavFor).data('flexslider2').animating && !$slide.hasClass('active')) {
                          slider.direction = (slider.currentItem < target) ? "next" : "prev";
                          slider.flexAnimate(target, slider.vars.pauseOnAction, false, true, true);
                      }
                  });
      ...
      sync: function(action) {
        var $obj = $(slider.vars.sync).data("flexslider2"),
    ...
    slider.flexAnimate = function(target, pause, override, withSync, fromNav) {
      ...
      if (!slider.animating && (slider.canAdvance(target, fromNav) || override) && slider.is(":visible")) {
        if (asNav && withSync) {
          var master = $(slider.vars.asNavFor).data('flexslider2');
