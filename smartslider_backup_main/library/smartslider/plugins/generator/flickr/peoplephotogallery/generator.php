...
class N2GeneratorFlickrPeoplePhotoGallery extends N2GeneratorAbstract
{

    function exists($photo, $empty = '') {
        if (isset($photo)) {
            return $photo;
        } else {
            return $empty;
    ...
    protected function _getData($count, $startIndex) {
        ...
        if ($galleryID != 0) {
            ...
            if (is_array($result['photos']['photo']) && !empty($result['photos']['photo'])) {
                ...
                N2Message::error(n2_('There are no photos in this gallery!'));
                return null;
            }
            ...
            N2Message::error(n2_('Please chooose a gallery!'));
        }
        return $data;
    }
}