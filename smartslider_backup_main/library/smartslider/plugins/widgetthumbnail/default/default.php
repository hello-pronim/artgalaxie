...
class N2SSPluginWidgetThumbnailDefaultHorizontal extends N2SSPluginWidgetThumbnailDefault {
    ...
    var $_name = 'defaultHorizontal';

    static function getDefaults() {
        return array_merge(N2SSPluginWidgetThumbnailDefault::getDefaults(), array(
...
N2Plugin::addPlugin('sswidgetthumbnail', 'N2SSPluginWidgetThumbnailDefaultHorizontal');

class N2SSPluginWidgetThumbnailDefaultHorizontalGallery extends N2SSPluginWidgetThumbnailDefault {

    var $_name = 'defaultHorizontalGallery';
...
N2Plugin::addPlugin('sswidgetthumbnail', 'N2SSPluginWidgetThumbnailDefaultHorizontalGallery');

class N2SSPluginWidgetThumbnailDefaultVertical extends N2SSPluginWidgetThumbnailDefault {

    var $_name = 'defaultVertical';
...
N2Plugin::addPlugin('sswidgetthumbnail', 'N2SSPluginWidgetThumbnailDefaultVertical');

class N2SSPluginWidgetThumbnailDefaultVerticalText extends N2SSPluginWidgetThumbnailDefault {

    var $_name = 'defaultVerticalText';

    static function getDefaults() {
        return array_merge(N2SSPluginWidgetThumbnailDefaultVertical::getDefaults(), array(
...
N2Plugin::addPlugin('sswidgetthumbnail', 'N2SSPluginWidgetThumbnailDefaultVerticalText');
