...
$top3_counted = 0;
if ($this->countModules('top-3a')) $top3_counted++;
if ($this->countModules('top-3b')) $top3_counted++;
if ($this->countModules('top-3c')) $top3_counted++;
if ($this->countModules('top-3d')) $top3_counted++;
if ($this->countModules('top-3e')) $top3_counted++;
if ($this->countModules('top-3f')) $top3_counted++;
if ( $top3_counted == 6 ) {
	$top3_width = '16.66%';
}
