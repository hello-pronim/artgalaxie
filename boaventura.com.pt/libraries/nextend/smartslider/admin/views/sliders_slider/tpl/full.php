  ...
  <div class="nextend-form" style="background: #EEF3F8;">
	  <h2>Buy full version</h2>   
	  	<div class="ni wrapper">  
			...
			<h3>Why should I upgrade to full version? Because you get all:</h3>
			<ul>
			...
			<h3>Slider features and limitations in trial version</h3>			
			...
			<h3>Slide features and limitations in trial version</h3>			
			...
			<h3>Generator features and limitations in trial version</h3>			
			<p>The trial version comes with the image from folder generator. You will need to select source folder which contains your images and Smart Slider 2 will automatically create the slides for you. The full version comes with a lot of other integration (Joomla content, WordPress post generator, Cobalt CCK, K2, redSHOP, JoomShopping, MijoShop, Phoca Gallery, Ignite Gallery, VirtueMart 2) and also with social generators ( Facebook, Twitter, Instagram, Flickr, YouTube ).</p>
			
			<h3>What comes with trial version?</h3>			
