...
function generateDynamicThumbs($controller, $path, $group, $type, $title, $configured, $full, $available){
    ...
    <div class="smartslider-dynamic-thumb">
        ...
        <?php else: ?>
            <a class="button small b" href="<?php echo $controller->route('controller=sliders&view=sliders_generator&action=generatorsettings&sliderid='.NextendRequest::getInt('sliderid').'&group='.$group.'&type='.$type); ?>">Start</a>
        <?php endif; ?>
    </div>
    <?php
}
