...
class NextendFilesystem extends NextendFilesystemAbstract{
	...
	if (defined('MULTISITES_ID')) {
	    $this->_basepath = realpath(JPATH_PLATFORM . '/..') . '/';
	} else {
	    $this->_basepath = JPATH_SITE == '' ? '' : JPATH_SITE . DIRECTORY_SEPARATOR;
	}
	
	$this->_cachepath = getNextend('cachepath', $this->_basepath . 'media' . DIRECTORY_SEPARATOR . 'nextend' . DIRECTORY_SEPARATOR . 'cache' . DIRECTORY_SEPARATOR);
