...
$document->addCustomTag("<script src='".$baseurl."modules/mod_j51thumbsgallery/js/slimbox2.js' type='text/javascript'></script>");

$document->addStyleSheet('modules/mod_j51thumbsgallery/css/thumbs_style.css');
$document->addStyleSheet('modules/mod_j51thumbsgallery/css/slimbox.css');
...
<?php 
		...
		<a class="j51Box" style="margin:<?php echo $margin;?>px;" rel="lightbox-thumbs" href="<?php echo $item['image'] ?>">
