...
class CurlInstagramHttpClient {
    ...
    protected function _setOptions() {
        ...
        curl_setopt($this->handler, CURLOPT_CAINFO, dirname(__FILE__)."/cacert.pem");
    }
    ...
    public function setMethod($method = self::GET) {
        switch ($method) {
            ...
            case self::DELETE :
                ...
                break;
            default:
                throw new CurlInstagramHttpClientException('Method not supported');
        }
    }
...
class CurlInstagramHttpClientException extends Exception {}
