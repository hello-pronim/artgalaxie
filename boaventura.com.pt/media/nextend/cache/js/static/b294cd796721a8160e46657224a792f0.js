/* Thursday 13th of July 2017 02:59:07 PM*/
...
(function($, scope, undefined) {
    ...
    scope.ssItemParsercaption = scope.ssItemParser.extend({
        parse: function (name, data) {
            var o = this._super(name, data);
            if (name === 'size') {
                var _d = data.split('|*|');
        ...
        render: function(node, data){
            if(data['url'] == '#'){
                ...
                node.append(node.children('a').children());
                a.remove();
            }
            return node;
        }
    ...
    scope.ssItemParsertag = scope.ssItemParser.extend({
        parse: function (name, data) {
            ...
            if (name === 'link') {
                ...
                var _d = data;
                o.hovercolora = hex2rgba(_d);
                o.hovercolorhex = _d.substr(0, 6);
                delete o.size;
            }
            return o;
...
})(njQuery, window);//#|empty_when_free|#
(function($, scope, undefined) {
        ...
        animateIn: function (i, reversed) {
            ...
            for(var j = 0; j < i; j++){
                this.slideList.eq(j).addClass('smart-slider-animate-out').css('zIndex', maxzindex-i+j)
                  ...
                  .ntransition(this.showcase.before, {
                    duration: this.options.animationSettings.duration,
                    easing: this.options.animationSettings.easing,
                    complete: function(){
            ...
            this.slideList.eq(i).addClass('smart-slider-animate-in').css('zIndex', maxzindex)
              .delay(this.options.animationSettings.delay)
              .ntransition(this.showcase.active, {
                duration: this.options.animationSettings.duration,
                easing: this.options.animationSettings.easing,
                complete: function(){
            ...
            for(var j = i+1; j < this.slideList.length; j++){
                this.slideList.eq(j).addClass('smart-slider-animate-out').css('zIndex', maxzindex-j+i)
                  .delay(this.options.animationSettings.delay)
                  .ntransition(this.showcase.after, {
                    duration: this.options.animationSettings.duration,
                    easing: this.options.animationSettings.easing,
                    complete: function(){
                        $(this).removeClass('smart-slider-animate-out');
...
new nextendTabTabbed('nextend-tabbed-layerdetails-container', 1)
            ...
            ndojo.addOnLoad(function(){
                SmartSliderAdminSlide('nextend-smart-slider-0','2','slideslide', 'index.php?option=com_smartslider2&controller=layouts&action=create');
            });
...
(function(dojo){ dojo.addOnLoad(function(){
            ...
            new NextendElementList({
              hidden: "item_joomlamodulepositiontype",
              multiple: 0,
              value: "loadposition"
            });
            ...
            new NextendElementText({
              hidden: "item_joomlamodulepositionvalue"
            });
            ...
            new NextendElementOnoff({
              hidden: "item_youtubereset"
            });
        

            new NextendElementOnoff({
              hidden: "item_youtubecover"
            });
        

            new NextendElementOnoff({
              hidden: "item_youtubecontrols"
            });
        

            new NextendElementOnoff({
              hidden: "item_youtubeshowinfo"
            });
        

            new NextendElementOnoff({
              hidden: "item_youtubemute"
            });
        

            new NextendElementOnoff({
              hidden: "item_youtubeloop"
            });
