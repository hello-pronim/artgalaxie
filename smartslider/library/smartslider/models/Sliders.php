...
class N2SmartsliderSlidersModel extends N2Model {
    ...
    private static function editForm($data = array()) {
        ...
        $backgroundMode = $form->get('backgroundMode');
        if ($backgroundMode == 'fixed') {
            $form->set('backgroundMode', 'fill');
            $form->set('slide-background-parallax', '1');
            $form->set('slide-background-parallax-strength', 100);
        }

        $slideBackgroundParallax = new N2ElementGroup($generalTab2, 'slide-background', n2_('Slide Background Parallax'));
        new N2ElementOnOff($slideBackgroundParallax, 'slide-background-parallax', n2_('Enabled'), 0, array(
            'relatedFields' => array(
                'sliderslide-background-parallax-strength',
                'sliderbg-parallax-tablet',
                'sliderbg-parallax-mobile'
            )
        ));
        new N2ElementList($slideBackgroundParallax, 'slide-background-parallax-strength', n2_('Strength'), 50, array(
            'options' => array(
        ...
        new N2ElementOnOff($slideBackgroundParallax, 'bg-parallax-tablet', n2_('Tablet'), 0);
        new N2ElementOnOff($slideBackgroundParallax, 'bg-parallax-mobile', n2_('Mobile'), 0);
        ...
        new N2ElementOnOff($desktopLandscape, 'desktop-landscape', n2_('Enable'), 0, array(
            'relatedFields' => array(
                ...
                'sliderdesktop-landscape-minimum-font-size'
            )
        ));
        ...
        new N2ElementOnOff($tabletPortrait, 'tablet-portrait', n2_('Enable'), 0, array(
            'relatedFields' => array(
                ...
                'slidertablet-portrait-minimum-font-size'
            )
        ));
        ...
        new N2ElementOnOff($tabletLandscape, 'tablet-landscape', n2_('Enable'), 0, array(
            'relatedFields' => array(
                ...
                'slidertablet-landscape-minimum-font-size'
            )
        ));
        ...
        new N2ElementOnOff($mobilePortrait, 'mobile-portrait', n2_('Enable'), 0, array(
            'relatedFields' => array(
                ...
                'slidermobile-portrait-minimum-font-size'
            )
        ));
        ...
        new N2ElementOnOff($mobileLandscape, 'mobile-landscape', n2_('Enable'), 0, array(
            'relatedFields' => array(
                ...
                'slidermobile-landscape-minimum-font-size'
            )
        ));
        ...
        new N2ElementOnOff($parallaxGroup, 'parallax-enabled', n2_('Enable'), 1, array(
            'relatedFields' => array(
                'sliderparallax-enabled-mobile',
                'sliderparallax-3d',
                'sliderparallax-animate',
                'sliderparallax-horizontal',
                'sliderparallax-vertical',
                'sliderparallax-mouse-origin',
                'sliderparallax-scroll-move'
            )
        ));
        ...
        new N2ElementOnOff($optimizeSlides, 'slides-background-video-mobile', n2_('Show background video on mobile'), 1);
