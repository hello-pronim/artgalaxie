...
class N2SS3 {
    ...
    public static function hasApiError($status, $data = array()) {
        ...
        switch ($status) {
            ...
            case 'DOMAIN_REGISTER_FAILED':
                N2Message::error('Smart Slider 3 is not activated on the current domain. You can move it to this domain like <a href="https://smartslider3.helpscoutdocs.com/article/1101-activation#move" target="_blank">this</a>, or get new one: <a href="https://smartslider3.com/pricing" target="_blank">smartslider3.com</a>');
                break;
            case 'LICENSE_INVALID':
                N2Message::error('Smart Slider 3 is not activated on the current domain. Please <a href="https://smartslider3.helpscoutdocs.com/article/1101-activation" target="_blank">activate it again</a> or buy a new package: <a href="https://smartslider3.com/pricing" target="_blank">smartslider3.com</a>');
    ...
    public static function initLicense() {
        ...
        N2JS::addInline("new N2Classes.License(" . json_encode(array(
                'activated'     => $model->hasKey(),
                'maybeActive'   => $model->maybeActive(),
                'activationUrl'  => N2SS3::getActivationUrl(array(
                    'utm_source'   => 'activate',
                ...
                'ajaxUrl'       => N2Base::getApplication('smartslider')->router->createUrl(array('license/add'))
            )) . ");");
