...
global $wpdb;
require_once dirname(__FILE__) . '/class-wp-error.php';
require_once dirname(__FILE__) . '/wp-db.php';
$wpdb = new wpdb(N2NativeConfig::$DB_USER, N2NativeConfig::$DB_PASSWORD, N2NativeConfig::$DB_NAME, N2NativeConfig::$DB_HOST);

if (!empty(N2NativeConfig::$TABLE_PREFIX)) {
    $wpdb->set_prefix(N2NativeConfig::$TABLE_PREFIX, false);
}
