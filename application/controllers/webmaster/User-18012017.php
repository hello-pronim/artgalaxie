					...
					if (( (($_FILES["feature_video"]["type"] == "video/mp4")
						...
						{	 
							if ($_FILES["feature_video"]["error"] > 0){
							  ...
							  @unlink('./uploads/artist_video/'.$this->input->post('old_image_name'));
							} 
						}
				}else if($this->input->post('old_image_name')!=''){
						$video_name = $this->input->post('old_image_name');
				}
