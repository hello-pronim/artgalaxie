...
class Upload_standards extends CI_Controller {
	...
	function manage($id=0,$mode='')
	{
		...
		{			
			...
			redirect("webmaster/manage_upload_standards/index");
		}
		...
		if ($mode=="update")
		{
			...
			redirect("webmaster/manage_upload_standards/index","refresh");
		}
