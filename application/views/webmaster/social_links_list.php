      ...
      <div class="row wrapper border-bottom white-bg page-heading">
        <div class="col-lg-8">
          ...
          <ol class="breadcrumb">
            ...
            <li class="active"><strong>Social Links List</strong></li>
          </ol>
        </div>
        <div class="col-lg-4"><div class="title-action">
            <a class="btn btn-primary pull-right" href="<?=site_url('webmaster/social_links/manage_social_links')?>">Add Social Links</a>
          </div></div>
      </div>
      <div class="wrapper wrapper-content animated fadeInRight">
        ...
        <div class="row "><div class="col-lg-12"><div class="ibox float-e-margins">
         ...
         <div class="ibox-title ">
          <h5 class="pull-left">Social Links List</h5>
          ...
          <form name="frmcustlist" method="post"  class="form-horizontal" > 
           <table class="table table-striped table-bordered table-hover dataTables-example" cellspacing="0" width="100%">
              ...
              <tbody>  
                ...
                <tr>
                  <td align="left"><?=stripslashes($dataRs['link_for']);?></td>
                  <td align="left"><?=stripslashes($dataRs['link']);?></td>
                  <td align="center">
                    <?php if($dataRs['icon']!=''){ ?>
                    <img src="<?=base_url()?>front_assets/images/<?=$dataRs['icon']?>" width="50%" class="image-responsive">
                    <?php }else{ ?>
                    <img src="<?=base_url()?>webmaster_assets/img/noImage.jpg" width="50%" class="image-responsive">
                    <?php } ?>
                  </td>
                  <td align="center"><a href="<?=site_url('webmaster/social_links/manage/'.$dataRs['id'])?>" title="Edit" >
                    <i class="fa fa-edit"></i></a>&nbsp;</td>
                </tr>   
            
              <? } ?>
              <? }?></tbody>
              <tfoot><tr><td  colspan="3"></td></tr>
              </tfoot>           
            </table>
          </form> 
        </div>
