      ...
      <div class="row wrapper border-bottom white-bg page-heading">
        <div class="col-lg-8">
          ...
          <ol class="breadcrumb">
            ...
            <li><a>Manage Video Content</a></li>
            <li class="active"><strong>Video Production </strong></li>
          </ol>
        </div>
        </div>
        ...
        <?php if(isset($id) && $id>0){ ?>
           <div class="row "><div class="col-lg-12"><div class="ibox float-e-margins">
            <div class="ibox-title">
              <h5><?=$btnCapt?> Video Production</h5>
            ...
            <? } ?>
            <form action="<?=site_url('webmaster/video_production/manage/'.$id)?>" method="post" enctype="multipart/form-data" name="frm" id="frm" class="form-horizontal">
         ...
         <? // if( @$boxData['desc_image']!='' &&  $id>0){ // ?>
          ...
          <div class="form-group">
           ...
           <div class="col-lg-10">
             ...
             <img src="<?=base_url()?>uploads/video-production/<?=$boxData['desc_image']?>" width="30%" class="image-responsive">
           </div>
         </div>  
         <? // } ?>
       ...
       <div class="form-group">
        <div class="col-sm-4 col-sm-offset-2">
         <a href="<?=site_url('webmaster/video_production/');?>" class="btn btn-white">Cancel</a>
...
<div class="row "><div class="col-lg-12"><div class="ibox float-e-margins">
 ...
 <div class="ibox-title ">
  <h5 class="pull-left">Video Production Listing </h5>
  <div class="clearfix"> </div>
</div>
<div class="ibox-content">
    ...
    <table class="table table-striped table-bordered table-hover dataTables-example" cellspacing="0" width="100%">
      ...
      <tbody>  
        ...
        <tr>
          ...
          <td align="center">
            <a href="<?=site_url('webmaster/video_production/manage/'.$dataRs['id'])?>" title="Edit" >
