       ...
       <? $this->load->view('webmaster/template/top'); ?>
        ...
        <div class="col-lg-8">
          ...
          <ol class="breadcrumb">
            ...
            <li><a>Manage Slider Images</a></li>
            <li class="active"><strong><?=$btnCapt?> Slider Images</strong></li>
          </ol>
        </div>
        <div class="col-lg-4"><div class="title-action">
            <a class="btn btn-primary pull-right" href="<?=site_url('webmaster/manage_slider')?>">Back to the list</a>
          </div>
        </div>
      </div>
        ...
        <div class="row "><div class="col-lg-12"><div class="ibox float-e-margins">
            <div class="ibox-title">
    			<h5><?=$btnCapt?> Slider Images</h5>
    		 <div class="clearfix">&nbsp;</div>
    		</div>
         <div class="ibox-content">
         <form action="<?=site_url('webmaster/manage_slider/manage/'.$banner_id)?>" method="post" enctype="multipart/form-data" name="frm" id="frm" class="form-horizontal">
          ...
          <div class="form-group"><label class="col-lg-2 control-label">Status</label>
           ...
           <div class="hr-line-dashed"></div>
            <div class="form-group">
              ...
              <a href="<?=site_url('webmaster/manage_slider');?>" class="btn btn-white">Cancel</a>
