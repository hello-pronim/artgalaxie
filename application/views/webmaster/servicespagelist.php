            ...
            <table class="table table-striped table-bordered table-hover dataTables-example" cellspacing="0" width="100%">
              ...
              <tbody>  
                ...
                <tr>
                  ...
                  <td align="left"><?=$this->common->cut(stripslashes($dataRs['services_short_description']),100)?></td>
                  <td align="left">
                      <? if($dataRs['services_page_images']!=''){ ?>
                    <img src="<?=base_url()?>uploads/services/<?=$dataRs['services_page_images']?>" width="10%" class="image-responsive">
                    <? }else{ ?>
                    <img src="<?=base_url()?>webmaster_assets/img/noImage.jpg" width="10%" class="image-responsive">
                    <? } ?></td>
                  <td align="center">
                    <a href="<?=site_url('webmaster/services_page/manage_services/'.$dataRs['id'])?>" title="Edit" >
