    ...
    <div id="page-wrapper" class="gray-bg dashbard-1">
      ...
      <div class="row wrapper border-bottom white-bg page-heading">
        ...
        <div class="col-lg-4"><div class="title-action">
            <a class="btn btn-primary pull-right" href="<?=site_url('webmaster/faqs/manage')?>">Add FAQ </a>
          </div>
        </div>
      </div>
      <div class="wrapper wrapper-content animated fadeInRight">
        ...
        <div class="row "><div class="col-lg-12"><div class="ibox float-e-margins">
         ...
         <div class="ibox-title ">
          <h5 class="pull-left">FAQ Listing </h5>
         ...
         <div class="ibox-content">
          ...
          <form name="frmcustlist" method="post"  class="form-horizontal"  action="<?=site_url("webmaster/faqs/delete")?>" onSubmit="JavaScript:return confirm_delete()"> 
           <input type="hidden" value="delete" name="action" />
                    <table class="table table-striped table-bordered table-hover dataTables-example" cellspacing="0" width="100%">
              <thead>
                <tr>
                    <th width="30%" align="left">Questions </th>
                    <th width="50%" align="left">Answers </th>
              ...
              <tbody>  
                ...
                <?php foreach($dataDs as $dataRs){ ?>
                 <tr>
                     <td align="center">
                    <?=$dataRs['content_title'] ?>
                  </td>
                   <td align="left">
                  <?=$dataRs['content_body']?>
                  </td>
                  <td align="center">
                    <a href="<?=site_url('webmaster/faqs/manage/'.$dataRs['article_id'])?>" title="Edit" ><i class="fa fa-edit"></i></a>
                    </td>
                 
                  <td align="center">
                    <input type="checkbox" name="cb[]" value="<?=$dataRs['article_id']?>" ></td>
                </tr>  
