...
<body >
    ...
    <div id="page-wrapper" class="gray-bg dashbard-1">
      ...
      <div class="row wrapper border-bottom white-bg page-heading">
        ...
        <div class="col-lg-4"><div class="title-action">
          <a class="btn btn-primary pull-right" href="<?=site_url('webmaster/art_of_giving/manage_just_giving_websites')?>" >Add new</a>
        </div> </div>
      </div>
      <div class="wrapper wrapper-content animated fadeInRight">
        <div class="row "><div class="col-lg-12"><div class="ibox float-e-margins">
         ...
         <div class="ibox-content">
          ...
          <form name="frmcustlist" method="post" action="<?=site_url("webmaster/art_of_giving/delete_just_giving_website")?>" onSubmit="JavaScript:return confirm_delete()" class="form-horizontal">
              ...
              <tbody>  
                <? if($num_rec>0){
                  ...
                  <tr>
                   ...
                   <td align="left">
                      <? if(@$category['banner1']!=''){ ?>
                    <img src="<?=base_url()?>uploads/art_of_giving/<?=$category['banner1']?>" width="10%" class="image-responsive">
                    <? }else{ ?>
                    <img src="<?=base_url()?>webmaster_assets/img/noImage.jpg" width="10%" class="image-responsive">
                    <? } ?></td>
                     <td align="left"><?=stripslashes($category['giving_websites_text'])?></td>
 <!--                   <td align="center"><a href="<?=site_url('webmaster/regionwise_gallery/manage_photo_gallery/'.$category['cat_id']);?>">Manage Photo Gallery</a></a></td> -->
                   <td align="center"><a href="<?=site_url('webmaster/art_of_giving/manage_just_giving_websites/'.$category['id']);?>"><i class="fa fa-edit"></i></a></a></td>
