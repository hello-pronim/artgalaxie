      ...
      <div class="row wrapper border-bottom white-bg page-heading">
        <div class="col-lg-8">
          ...
          <ol class="breadcrumb">
            ...
            <li class="active"><strong>Upload Standards List</strong></li>
          </ol>
        </div>
        <!--<div class="col-lg-4"><div class="title-action">
            <a class="btn btn-primary pull-right" href="<?=site_url('webmaster/upload_standards/manage')?>">Add Upload Standards</a>
          </div></div>-->
      </div>
      <div class="wrapper wrapper-content animated fadeInRight">
        ...
        <div class="row "><div class="col-lg-12"><div class="ibox float-e-margins">
         ...
         <div class="ibox-title ">
          <h5 class="pull-left">Upload Standard List</h5>
           ...
           <table class="table table-striped table-bordered table-hover dataTables-example" cellspacing="0" width="100%">
              ...
              <tbody>  
                ...
                <tr>
                  ...
                  <td align="left"><?=stripslashes($dataRs['description']);?></td>
                  <td align="center"><a href="<?=site_url('webmaster/upload_standards/manage/'.$dataRs['id'])?>" title="Edit" >
