      ...
      <div class="row wrapper border-bottom white-bg page-heading">
        <div class="col-lg-8">
          ...
          <ol class="breadcrumb">
            ...
            <li><a>Manage Art</a></li>
            <li class="active"><strong>Art</strong></li>
          </ol>
        </div>
        </div>
        ...
        <?php if(isset($id) && $id>0){ ?>
           <div class="row "><div class="col-lg-12"><div class="ibox float-e-margins">
            ...
            <? } ?>
            <form action="<?=site_url('webmaster/services_page/art/'.$id)?>" method="post" enctype="multipart/form-data" name="frm" id="frm" class="form-horizontal">
         ...
         <? if(@$boxData['services_short_description']!=''){ ?>
		  ...
		  <div class="form-group">
		   ...
		   <div class="col-lg-10">
			 ...
			 <img src="<?=base_url()?>uploads/art/<?=$boxData['services_page_images']?>" width="30%" class="image-responsive">
		   </div>
		 </div>  
		 <? } ?>
       ...
       <div class="form-group">
        <div class="col-sm-4 col-sm-offset-2">
         <a href="<?=site_url('webmaster/services_page/art');?>" class="btn btn-white">Cancel</a>
         <input type="submit" class="btn btn-primary" id="btnsave" value="<?=$btnCapt?> Art" name="btnsave">
       </div>
     </div>
   </form>
 </div>
...
<div class="row "><div class="col-lg-12"><div class="ibox float-e-margins">
 ...
 <div class="ibox-title ">
  <h5 class="pull-left">Art Listing </h5>
  <div class="clearfix"> </div>
</div>
<div class="ibox-content">
      ...
      <tbody>  
        ...
        <tr>
          <td><?php  echo stripslashes($dataRs['title']); ?></td>
            <td align="center">
             <a href="<?=site_url('webmaster/services_page/Art/'.$dataRs['id'])?>"  title="Edit" >
