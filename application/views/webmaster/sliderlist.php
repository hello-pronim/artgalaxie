      ...
      <div class="row wrapper border-bottom white-bg page-heading">
        <div class="col-lg-8">
          ...
          <ol class="breadcrumb">
            ...
            <li class="active"><strong>Slider List</strong></li>
          </ol>
        </div>
        <div class="col-lg-4"><div class="title-action">
            <a class="btn btn-add btn-primary pull-right" href="<?=site_url('webmaster/manage_slider/manage')?>">Add Slider</a>
          </div></div>
      </div>
      <div class="wrapper wrapper-content animated fadeInRight">
        ...
        <div class="row "><div class="col-lg-12"><div class="ibox float-e-margins">
         ...
         <div class="ibox-content">
          ...
          <form name="frmcustlist" method="post"  class="form-horizontal"  action="<?=site_url("webmaster/manage_slider/delete_slider")?>" onSubmit="JavaScript:return confirm_delete()"> 
              ...
              <tbody>  
                ...
                <tr>
                  ...
                  <td align="center"><? if($dataRs['banner_status']==1){ echo "Show"; }else{ echo "Hide";}?></td>
                    <td align="center">
                    <a href="<?=site_url('webmaster/manage_slider/manage/'.$dataRs['banner_id'])?>" title="Edit" >
                    <i class="fa fa-edit"></i></a>
                    <td align="center">
                    <input type="checkbox" name="cb[]" value="<?=$dataRs['banner_id']?>" ></td>
                </tr>   
