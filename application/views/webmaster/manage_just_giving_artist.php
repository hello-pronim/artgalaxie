...
<div class="wrapper wrapper-content animated fadeInRight">
  <div class="row "><div class="col-lg-12"><div class="ibox float-e-margins">
    ...
    <? } ?>
    <form action="<?=site_url('webmaster/art_of_giving/manage_just_giving_to_artist/'.$id)?>" method="post" enctype="multipart/form-data" name="frm" id="frm" class="form-horizontal">
...
<div class="ibox-content">
  ...
  <form name="frmcustlist" method="post"  class="form-horizontal"  action="<?=site_url("webmaster/art_of_giving/delete_just_giving_to_artist")?>" onSubmit="JavaScript:return confirm_delete()"> 
 ...
 <!--                   <td align="center"><a href="<?=site_url('webmaster/regionwise_gallery/manage_photo_gallery/'.$category['id']);?>">Manage Photo Gallery</a></a></td> -->
                   <td align="center"><a href="<?=site_url('webmaster/art_of_giving/manage_just_giving_to_artist/'.$category['id']);?>"><i class="fa fa-edit"></i></a></a></td>
