   ...
   <div class="row wrapper border-bottom white-bg page-heading">
    <div class="col-lg-8">
      ...
      <ol class="breadcrumb">
        ...
        <li><a>Manage City</a></li>
        <li class="active"><strong><?=$btnCapt?> City</strong></li>
      </ol>
    </div>
    <div class="col-lg-4"><div class="title-action">
      <a class="btn btn-primary pull-right" href="<?=site_url('webmaster/categories/city_list')?>">Back to the list</a>
    </div>
  </div>
</div>
<div class="wrapper wrapper-content animated fadeInRight">
  <div class="row "><div class="col-lg-12"><div class="ibox float-e-margins">
    ...
    <? } ?>
    <form action="<?=site_url('webmaster/categories/manage_city/'.$id)?>" method="post" enctype="multipart/form-data" name="frm" id="frm" class="form-horizontal">
      <input type="hidden" name="mode" value="<?=$btnCapt?>" />
      <div class="form-group">
       <label class="col-lg-2 control-label">&nbsp;Title</label>
       <div class="col-lg-10">
        <input type="text" name="city_name" id="city_name" class="form-control" value="<?php if(@$form_data['city_name']!=""){ echo $form_data['city_name'];}else{ echo set_value('city_name');  } ?>" />
                <span class="help-block text-danger">
                  <?php if(form_error('city_name')!=""){  echo  form_error('city_name'); } ?>
        </span> 
       </div>  
     </div>
    ...
    <div class="form-group">
     ...
     <div class="form-group">
      <div class="col-sm-4 col-sm-offset-2">
       <a href="<?=site_url('webmaster/categories/city_list');?>" class="btn btn-white">Cancel</a>
