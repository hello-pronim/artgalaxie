   ...
   <div class="row wrapper border-bottom white-bg page-heading">
    <div class="col-lg-8">
      ...
      <ol class="breadcrumb">
        ...
        <li><a>Manage Style</a></li>
        <li class="active"><strong><?=$btnCapt?> Style</strong></li>
      </ol>
    </div>
    <div class="col-lg-4"><div class="title-action">
      <a class="btn btn-primary pull-right" href="<?=site_url('webmaster/categories/style_list')?>">Back to the list</a>
    </div>
  </div>
</div>
<div class="wrapper wrapper-content animated fadeInRight">
  <div class="row "><div class="col-lg-12"><div class="ibox float-e-margins">
    ...
    <? } ?>
    <form action="<?=site_url('webmaster/categories/manage_style/'.$cat_id)?>" method="post" enctype="multipart/form-data" name="frm" id="frm" class="form-horizontal">
      <input type="hidden" name="mode" value="<?=$btnCapt?>" />
      <div class="form-group">
       <label class="col-lg-2 control-label">&nbsp;Title</label>
       <div class="col-lg-10">
        <input type="text" name="cat_name" id="cat_name" class="form-control" value="<?php if(@$form_data['cat_name']!=""){ echo $form_data['cat_name'];}else{ echo set_value('cat_name');  } ?>" />
     ...
     <div class="form-group">
        ...
        <div class="form-group"><label class="col-lg-2 control-label">Style Image</label>
          <div class="col-lg-10">
            <div class="radio i-checks">
             <input type="file" name="image_name" id="image_name" > 
             <input type="hidden" name="old_image_name" id="old_image_name"  value="<?=@$form_data['image_name']?>"> 
             <span style="font-size:10px;color:gray;">Image Size (302 X 255)<span>
            </div>
          </div>
        </div>

        <?php if(@$form_data['image_name']!=''){ ?>
          <div class="form-group"><label class="col-lg-2 control-label">Old Style Image</label>
          <div class="col-lg-10">
            <div class="radio i-checks">
            <input type="hidden" name="old_image_name" id="old_image_name"  value="<?=@$form_data['image_name']?>"> 
            <img src="<?=base_url()?>uploads/style_images/<?=$form_data['image_name']?>" class="img-responsive">
            </div>
          </div>
        </div>
        <?php } ?>
     ...
     <div class="form-group">
      <div class="col-sm-4 col-sm-offset-2">
       <a href="<?=site_url('webmaster/categories/style_list');?>" class="btn btn-white">Cancel</a>
