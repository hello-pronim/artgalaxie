    ...
    <div id="page-wrapper" class="gray-bg dashbard-1">
      ...
      <div class="row wrapper border-bottom white-bg page-heading">
        ...
        <div class="col-lg-4"><div class="title-action">
          <a class="btn btn-primary pull-right" href="<?=site_url('webmaster/product_attributes/manage_dimensions')?>" >Add new</a>
        </div></div>
      </div>
         ...
         <div class="ibox-content">
          ...
          <form name="frmcustlist" method="post" action="<?=site_url("webmaster/product_attributes/delete_colours")?>" onSubmit="JavaScript:return confirm_delete()" class="form-horizontal">
            ...
            <table class="table table-striped table-bordered table-hover dataTables-example" cellspacing="0" width="100%">
              <thead>
                <tr>
                  <th align="left">Title</th><th align="left">Dimention</th><th width="6%">Edit</th><th width="6%">Delete</th>
                </tr>
              </thead>
              <tbody>  
                <? if($num_rec>0){
                  foreach ($list_data as $dimensions) {?>
                  <tr>
                    <td align="left"><?=stripslashes($dimensions['title'])?></td>
                    <td align="left"><?=stripslashes($dimensions['length']." X ".$dimensions['width']." X ".$dimensions['height'])." ".CENTYMETTER?></td>
                    <td align="center"><a href="<?=site_url('webmaster/product_attributes/manage_dimensions/'.$dimensions['id']);?>"><i class="fa fa-edit"></i></a></a></td>
                    <td align="center"><input type="checkbox" name="cb[]" value="<?=$dimensions['id']?>" ></td>
                  </tr>   
                  <? } 
                }?>
              </tbody>
