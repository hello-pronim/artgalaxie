    ...
    <div id="page-wrapper" class="gray-bg dashbard-1">
      ...
      <div class="row wrapper border-bottom white-bg page-heading">
        ...
        <div class="col-lg-4"><div class="title-action">
          <a class="btn btn-primary pull-right" href="<?=site_url('webmaster/categories/manage_style')?>" >Add new</a>
        </div></div>
      </div>
      <div class="wrapper wrapper-content animated fadeInRight">
        <div class="row "><div class="col-lg-12"><div class="ibox float-e-margins">
         ...
         <div class="ibox-content">
          ...
          <form name="frmcustlist" method="post" action="<?=site_url("webmaster/categories/delete_style")?>" onSubmit="JavaScript:return confirm_delete()" class="form-horizontal">
            ...
            <table class="table table-striped table-bordered table-hover dataTables-example" cellspacing="0" width="100%">
              ...
              <tbody>  
                <? if($num_rec>0){
                  ...
                  <tr>
                    <td align="center"><img src="<?=base_url()?>uploads/style_images/<?=$category['image_name']?>" class="img_responsive" ></td>
                    <td align="left"><?=stripslashes($category['cat_name'])?></td>
                    <td align="center"><a href="<?=site_url('webmaster/categories/manage_style/'.$category['cat_id']);?>"><i class="fa fa-edit"></i></a></a></td>
