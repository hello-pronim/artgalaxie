      ...
      <div class="row wrapper border-bottom white-bg page-heading">
        <div class="col-lg-8">
          ...
          <ol class="breadcrumb">
            ...
            <li class="active"><strong>Shop Links List</strong></li>
          </ol>
        </div>
        <!--<div class="col-lg-4"><div class="title-action">
            <a class="btn btn-primary pull-right" href="<?=site_url('webmaster/shop_links/manage')?>">Add Shop Links</a>
          </div></div>-->
      </div>
      <div class="wrapper wrapper-content animated fadeInRight">
        ...
        <div class="row "><div class="col-lg-12"><div class="ibox float-e-margins">
         ...
         <div class="ibox-title ">
          <h5 class="pull-left">Shop Links List</h5>
         ...
         <div class="ibox-content">
          ...
          <form name="frmcustlist" method="post"  class="form-horizontal" > 
           <table class="table table-striped table-bordered table-hover dataTables-example" cellspacing="0" width="100%">
              <thead>
                <tr>
                  <th width="15%"align="left">Link For</th>
              ...
              <tbody>  
                ...
                <tr>
                  ...
                  <td align="center"><a href="<?=site_url('webmaster/shop_links/manage/'.$dataRs['id'])?>" title="Edit" >
