    ...
    class db {
    	...
    	function __construct($params=array()) {
            ...
            if($_SERVER['HTTP_HOST'] == "server:81"){
        		...
        		$this->baseName = 'art_galaxie_db'; //name of your database
        		$this->port = '3306';
            }else if($_SERVER['HTTP_HOST'] == "www." . $asiteurl || $_SERVER['HTTP_HOST'] == $asiteurl ){
                $this->host = 'localhost'; //hostname
                $this->user = 'awsdev'; //username
                $this->password = 'sandipdev'; //password
                $this->baseName = 'awsdev_art_galaxie'; //name of your database
                $this->port = '3306';
            }
    		$this->debug = true;
    		$this->connect();
